"""
Converts image to grayscale using PIL.
"""
...
class ImgGrayscale(PluginBase):
    def config(self) -> Dict[str, Any]:
        return {
            "name": "img_grayscale",
            "version": "1.0.0",
            "description": "Converts image to grayscale using PIL.",
            "category": "image",
            "tags": ['image'],
            "cost_per_exec": 0.005,
    ...
    def run(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        try:
            ...
            logger.error(f"Plugin img_grayscale failed: {e}")
            return {"error": str(e)}
