...
class MathMatrixMul(PluginBase):
    def config(self) -> Dict[str, Any]:
        return {
            "name": "math_matrix_mul",
            "version": "1.0.0",
            "description": "Multiplies two matrices (Mock).",
            "category": "math",
            "tags": ['math'],
            "cost_per_exec": 0.02,
            "inputs": {'matrix_a': 'list'},
            "outputs": {'result': 'list'}
        }
    ...
    def run(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        try:
            ...
            logger.error(f"Plugin math_matrix_mul failed: {e}")
            return {"error": str(e)}
