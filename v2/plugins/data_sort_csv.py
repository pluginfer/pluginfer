...
class DataSortCsv(PluginBase):
    def config(self) -> Dict[str, Any]:
        return {
            "name": "data_sort_csv",
            "version": "1.0.0",
            "description": "Sorts CSV data by column.",
            "category": "data",
            "tags": ['data'],
            "cost_per_exec": 0.005,
            "inputs": {'csv': 'str', 'column': 'str'},
            "outputs": {'sorted_csv': 'str'}
        }
    ...
    def run(self, input_data: Dict[str, Any]) -> Dict[str, Any]:
        try:
            ...
            logger.error(f"Plugin data_sort_csv failed: {e}")
            return {"error": str(e)}
